                              ...
                              <tr>
                                <td align="left" class="es-text-3294" bgcolor="#ffffff" style="padding:0;Margin:0">
                                  <h3 align="center"
                                    ...
                                    <strong>Hey Rohit thanks for your order.</strong></h3>
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:30px"><!--[if mso]><a href="https://localhost:5173/user" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://localhost:5173/user" 
                style="height:39px; v-text-anchor:middle; width:143px" arcsize="13%" stroke="f"  fillcolor="#ffffff">
		<w:anchorlock></w:anchorlock>
		<center style='color:#41de39; font-family:Raleway, Arial, sans-serif; font-size:14px; font-weight:700; line-height:14px;  mso-text-raise:1px'>View Order</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                    style="border-style:solid;border-color:#ffffff;background:#ffffff;border-width:1px;display:inline-block;border-radius:5px;width:auto;mso-hide:all"><a
                                      href="https://localhost:5173/user" class="es-button es-button-6982"
                                      target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#41de39;font-size:16px;padding:10px 30px 10px 30px;display:inline-block;background:#ffffff;border-radius:5px;font-family:Raleway, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:19px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #6A994E;border-color:#ffffff">View
